                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <%
                                            ...
                                            ItemDTO idto = idao.viewItem(itemId);
                                        ...
                                        <div style="display: flex; justify-content: center;">
                                            <div style="border: solid 1px;width: 700px;">
                                                <h1 style="padding: 10px 20px;margin: 0px;">Họ tên&nbsp &nbsp &nbsp &nbsp &nbsp : <%= cdao.viewCus(idto.getCustomerID())%></h1>
                                            ...
                                            <table class="table table-striped table-bordered zero-configuration" >
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="text-align: center;padding: 10px 5px;"><%= b.getPawnMoney() - b.getReturnMoney() %></td>
                                                    </tr>
                                                    <%               }
                                        ...
                                        %>
                                        <div style="display: flex; justify-content: center;"    >
                                            <button style="background-color: #00FF00;padding: 10px 20px;"><a style="text-decoration: none; color: black;" href="">Thêm</a></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
